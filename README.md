...
Notes:
- Make sure dh.json exists; otherwise, /dh/register/:id and /dh/:id may fail.
- All routes support CORS, allowing cross-origin requests.
- /fetch should be restricted or used carefully in production.
